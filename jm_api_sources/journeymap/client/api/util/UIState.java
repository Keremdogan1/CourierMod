...
public final class UIState
{
     ...
     */
    public UIState(Context.UI ui, boolean active, RegistryKey<World> dimension, int zoom,
                   @Nullable Context.MapType mapType,
                   @Nullable BlockPos mapCenter,
                   @Nullable Integer chunkY,
                   @Nullable Box blockBounds,
     ...
     * @return a UIState
     */
    public static UIState newInactive(Context.UI ui, MinecraftClient minecraft)
    {
        BlockPos center = minecraft.world == null ? new BlockPos(0, 68, 0) : minecraft.world.getSpawnPos();
