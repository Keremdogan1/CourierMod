...
public class FullscreenMapEvent extends ClientEvent
{
     ...
     */
    private FullscreenMapEvent(Type type, BlockPos location, RegistryKey<World> level)
    {
        super(type, level);
    ...
    public static class ClickEvent extends FullscreenMapEvent
    {
        ...
        public static class Pre extends ClickEvent
        {
            ...
            public Pre(BlockPos location, RegistryKey<World> level, Point2D.Double mousePosition, int button)
            {
        ...
        public static class Post extends ClickEvent
        {
            ...
            public Post(BlockPos location, RegistryKey<World> level, Point2D.Double mousePosition, int button)
            {
    ...
    public static class MouseMoveEvent extends FullscreenMapEvent
    {
         ...
         * @param level - The dimension.
         */
        public MouseMoveEvent(RegistryKey<World> level, IBlockInfo info, Point2D.Double mousePosition)
        {
